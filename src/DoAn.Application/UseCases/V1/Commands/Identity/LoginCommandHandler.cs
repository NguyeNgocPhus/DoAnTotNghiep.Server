...
public class LoginCommandHandler : ICommandHandler<LoginCommand, LoginResponse>
{
    ...
    public LoginCommandHandler(IJwtTokenService jwtTokenService, ICacheService cacheService, UserManager<AppUser> userManager, IPasswordGeneratorService passwordGeneratorService, RoleManager<AppRole> roleManager)
    {
